...
class User(db.Model):
    ...
    user_menus = db.relationship("Menu", secondary="user_menus", backref="users", lazy="dynamic", order_by=lambda: Menu.menu_code)
    user_resources = db.relationship("Resource", secondary="user_resources", backref="users", lazy="dynamic")
    user_roles = db.relationship("Role", secondary="user_roles", backref="users", lazy="dynamic")
