...
class Resource(db.Model):
    ...
    resource_roles = db.relationship("Role", secondary="role_resources", backref="resources", lazy="dynamic")
    resource_users = db.relationship("User", secondary="user_resources", backref="resources", lazy="dynamic")
